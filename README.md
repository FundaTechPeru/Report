...
| US-05 | Encontrar compañeros de viaje | **Como** pasajero, **quiero** conocer cuántos pasajeros ya han reservado un lugar en el vehículo, **para** saber qué tanto tardará en iniciar el recorrido. | • El pasajero visualiza la cantidad de pasajeros confirmados y el mínimo requerido para iniciar el viaje.<br>• El contador se actualiza cada vez que un pasajero se une o cancela su reserva.<br>• Se muestra una barra de progreso hacia el mínimo de pasajeros necesario para confirmar el viaje. | EP-02 |
...
| US-10 | Bloquear usuarios | **Como** pasajero, **quiero** bloquear a otros usuarios con los que tenga malas experiencias, **para** evitar compartir mi viaje con personas molestas. | • El pasajero puede bloquear a un conductor o pasajero desde el historial de viajes.<br>• Los usuarios bloqueados no vuelven a ser agrupados en los próximos viajes del pasajero.<br>• El pasajero puede ver y administrar su lista de usuarios bloqueados desde su perfil. | EP-06 |
...
| US-19 | Configurar disponibilidad y horarios | **Como** conductor, **quiero** configurar mis horarios y zonas de disponibilidad, **para** recibir propuestas de viaje que se ajusten a mi rutina. | • El conductor puede definir días, franjas horarias y zonas donde desea operar.<br>• El sistema solo envía propuestas de viaje dentro de la disponibilidad configurada.<br>• El conductor puede modificar su disponibilidad sin afectar los viajes ya confirmados. | EP-05 |
...
| US-21 | Aceptar o rechazar una propuesta de viaje | **Como** conductor, **quiero** aceptar o rechazar una propuesta de viaje, **para** gestionar mi disponibilidad y decidir qué recorridos realizar. | • Al aceptar, el viaje pasa a estado "confirmado" y se notifica a los pasajeros agrupados.<br>• Al rechazar, la propuesta se reasigna automáticamente a otro conductor disponible.<br>• El conductor puede consultar el historial de propuestas aceptadas y rechazadas. | EP-05 |
...
| US-27 | Calificar a los pasajeros | **Como** conductor, **quiero** calificar a los pasajeros al finalizar el viaje, **para** reportar mi experiencia y contribuir a la confianza dentro de la plataforma. | • Al finalizar el viaje, el conductor puede calificar de 1 a 5 estrellas a cada pasajero transportado.<br>• La calificación del pasajero se actualiza con el promedio de todas las calificaciones recibidas.<br>• Un pasajero con calificación por debajo del mínimo establecido recibe una advertencia de la plataforma. | EP-07 |
...
| US-30 | Ver y editar perfil y vehículo | **Como** conductor, **quiero** ver y editar mi perfil y los datos de mi vehículo, **para** mantener actualizada mi información dentro de la plataforma. | • El conductor puede editar sus datos de contacto y foto de perfil en cualquier momento.<br>• Cualquier cambio en los datos del vehículo requiere una nueva revisión de verificación.<br>• El sistema conserva un registro de la última fecha de actualización del perfil. | EP-08 |
